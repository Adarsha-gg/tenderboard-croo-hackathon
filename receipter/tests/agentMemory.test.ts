...
function sampleReceipt(overrides: Partial<LiveRunReceipt> = {}): LiveRunReceipt {
  ...
  const receipt: LiveRunReceipt = {
    ...
    verificationManifest: {
      ...
      claimResults: [{ objectType: 'receipter.claim_verification.v1', claimId: 'claim_1', sourceObservationId: 'obs_1', verdict: 'supported', supportScore: 96, reasons: [], sourceUrl: undefined, sourceTitle: undefined, observedAt: undefined, publishedAt: undefined }],
    },
    workerAgentId,
