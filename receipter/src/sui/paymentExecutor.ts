...
import type { LiveRunReceipt, SuiWalletTransactionRequest, ReceipterConfig, X402SuiPaymentPayload } from '../live/types.js';
...
export function buildSuiX402PaymentCliArgs(receipt: LiveRunReceipt, config: ReceipterConfig): string[] {
