...
import type { LiveRunReceipt, SuiReceiptAnchorPayload, SuiWalletTransactionRequest, ReceipterConfig } from '../live/types.js';
 ...
 */
export async function executeSuiAnchorReceipt(receipt: LiveRunReceipt, config: ReceipterConfig): Promise<SuiAnchorExecutionResult> {
...
export function buildSuiAnchorCliArgs(plan: SuiAnchorPlan, config: ReceipterConfig): string[] {
